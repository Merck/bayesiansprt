...
\title{Efficacy and Futility Boundaries for Bayesian and Frequentist SPRT
%%  ~~function to do ... ~~
}
\description{
This function provides the efficacy and futility boundaries for the sequential ratio probability test under the frequentist and Bayesian setup.
%%  ~~ A concise (1-5 lines) description of what the function does. ~~
}
\usage{
SPRTboundary(method, n.event, n.start, n.increment, ve.null, ve.alt, type1, power, ratio.alloc, optimum.w, w, a.prior, b.prior)
}
...
\item{optimum.w}{
TRUE if use optimum weight; FALSE if used provide the shape parameter a.prior; by default TRUE
}
\item{w}{
...
\item{boundary}{Number of events and corresponding efficacy and futility boundaries}
...
# Bayesian
SPRTboundary(method = "Bayes", n.event = n.event, n.start = n.start,
             n.increment = n.increment, ve.null = ve.null, ve.alt = ve.alt)

# Frequentist
SPRTboundary(method = "Freq", n.event = n.event, n.start = n.start,
             n.increment = n.increment, ve.null = ve.null, ve.alt = ve.alt)
